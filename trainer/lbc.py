    ...
    def train(self, train_loader, test_loader, epochs, dummy_loader=None, writer=None):
        ...
        for iter_ in range(n_iters):
            ...
            Y_pred_train, Y_train, S_train = self.get_statistics(train_loader.dataset, batch_size=self.batch_size,
                                                                 num_workers=self.num_workers, model=model)  ############################# ㅇㅋ
...
#     def get_error_and_violations_DP(self, binarized_y_pred, binarized_y, sen_attrs, num_groups):
...
#     def get_error_and_violations_Eopp(self, binarized_y_pred, binarized_y, sen_attrs, num_groups):
#         binarized_acc = np.mean(binarized_y_pred == binarized_y)
#         violations = []
#         for g in range(num_groups):
...
#     def get_error_and_violations_EO(self, binarized_y_pred, binarized_y, sen_attrs, num_groups): ###############################
#         binarized_acc = np.mean(binarized_y_pred == binarized_y)
#         violations = []
#         for g in range(num_groups):
