...
def get_args():
    ...
    parser.add_argument('--method', default='scratch', type=str, required=True,
                        choices=['scratch', 'lbc','mfd', 'adv', 'fairhsic', 'lgdro','gdro','gdro_epoch', 'fairbatch','gdro_chi','lgdro_chi','disp_mist','rw', 'fscl','renyi', 'variance','cgdro_new','cgdro_no_sampling', 'exp_grad_reduction','cotter','cotter_epoch', 'fairdro','fairdro_cotter', 'direct_reg'])
